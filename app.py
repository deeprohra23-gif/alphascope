        ...
        if sip_stocks and st.button("Calculate SIP Returns", key='sip_calc'):
            ...
            if all_results:
                ...
                for r in all_results:
                    ...
                    stock_rows += f'<tr><td style="padding:0.4rem 0.5rem;color:#e0e0e0;font-size:0.72rem;font-weight:600">{r["stock"].replace(".NS","")}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">₹{r["invested"]:,.0f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{ret_color};font-size:0.72rem">₹{r["value"]:,.0f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">{r["units"]:.2f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">₹{r["avg_cost"]:,.1f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">₹{r["cmp"]:,.1f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{ret_color};font-size:0.72rem">{r["return_pct"]:+.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{xirr_color};font-size:0.72rem">{r["xirr"]:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ff4d4d;font-size:0.72rem">{r["max_dd"]:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">{r["recovery"]}mo</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">{r["volatility"]:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.72rem">{r["start"]} ({r["months"]}mo)</td></tr>'

                port_ret_color = '#00d4aa' if port_return > 0 else '#ff4d4d'
                port_xirr_color = '#00d4aa' if port_xirr > 0 else '#ff4d4d'
                stock_rows += f'<tr style="border-top:2px solid #00d4aa33"><td style="padding:0.4rem 0.5rem;color:#00d4aa;font-size:0.72rem;font-weight:700">PORTFOLIO</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#e0e0e0;font-size:0.72rem;font-weight:600">₹{portfolio_invested:,.0f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{port_ret_color};font-size:0.72rem;font-weight:600">₹{portfolio_value:,.0f}</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">—</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">—</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ccc;font-size:0.72rem">—</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{port_ret_color};font-size:0.72rem;font-weight:600">{port_return:+.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:{port_xirr_color};font-size:0.72rem;font-weight:600">{port_xirr:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#ff4d4d;font-size:0.72rem;font-weight:600">{port_max_dd:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#e0e0e0;font-size:0.72rem;font-weight:600">{port_max_recovery}mo</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#e0e0e0;font-size:0.72rem;font-weight:600">{port_vol:.1f}%</td><td style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.72rem">—</td></tr>'

                breakdown_html = f'<div class="stock-card" style="margin-top:0.5rem"><div class="stock-card-section">Stock-wise Breakdown</div><div style="overflow-x:auto"><table style="{ts}"><tr style="{hb}"><th style="padding:0.4rem 0.5rem;text-align:left;color:#888;font-size:0.65rem">Stock</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Invested</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Value</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Units</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Avg Cost</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">CMP</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Return</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">XIRR</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Max DD</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Recovery</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Volatility</th><th style="padding:0.4rem 0.5rem;text-align:right;color:#888;font-size:0.65rem">Period</th></tr>{stock_rows}</table></div><div style="font-size:0.55rem;color:#555;font-family:IBM Plex Mono,monospace;margin-top:0.4rem">SIP on 1st trading day of each month · Fractional units · Past performance does not guarantee future returns</div></div>'
